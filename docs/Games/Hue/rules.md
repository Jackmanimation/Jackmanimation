...
This is based on the Vietnam War – Battle of the same name.The basic premise of the game is that six (6) players will control a squad of US soldiers. They will navigate Hue city to achieve an objection. The enemy units will be assigned at
...
- **Get to the LZ** (there is a Huey waiting to take the squad out of Hue) only one
    squad can go.
- **Rescue the POW** – A POW is set down and needs to be rescued and returned to a designated spot. There is only one POW.
- **Hold the Bridge** – Move to a point on the map and defend it
...
- **Capture the Flag** – Use Act to take the enemy flag and return it to your base.
...
Keep the deck at 10–12 unique cards, duplicated to form a deck of ~20–30 cards.
...
| RPG Team        | 2      | 10"   | RPG-2 + 1 AK-47            | Area effect (4"); one RPG shot per game.                |
...
- [Bar Code generator](https://qrcode.tec-it.com/en/Url)
- [Cards](https://www.bannerbuzz.co.uk/collector-cards/)
- [Cards](https://www.printerstudio.co.uk/create-own/blank-playing-cards.html)
